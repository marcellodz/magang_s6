...
if ($mode === 'claim') {
  ...
  // Pastikan verify_claim.php menerima iduser lewat $_GET
  $_GET['iduser'] = $iduser;

  // Jalankan verify_claim.php tanpa query string (PHP TIDAK BISA include file?id=xxx)
  ob_start();
  include __DIR__ . "/verify_claim.php";
